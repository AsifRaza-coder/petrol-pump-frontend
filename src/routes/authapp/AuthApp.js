  ...
  return (
    <div className={mode === "dark" ? "dark" : ""}>
      <BrowserRouter>
        ...
        <Alert />
        <div className="flex h-[calc(100vh-65px)] [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-400 relative">
          <Sidebar openSidebar={openSidebar} setOpenSidebar={setOpenSidebar} />
          <div className={`flex-1 overflow-y-auto transition-all duration-300 ${openSidebar ? 'lg:ml-0' : 'lg:ml-0'}`}>
            <Suspense fallback={<Loader />}>
              <Routes>
                ...
                <Route path="/meters" element={<Readings />} />
                <Route path="/products" element={<Products />} />
                <Route path="/prices" element={<Prices />} />
                <Route path="/sales" element={<TotalSale />} />
                <Route path="/pos" element={<TotalSale />} />
