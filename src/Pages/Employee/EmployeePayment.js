...
import { AssignmentInd, AttachMoney, SwitchAccount, Payment } from "@mui/icons-material";
...
const EmployeePayment = () => {
  ...
  return (
    ...
    >
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
          <Box>
            ...
            <Typography variant="body2" color="text.secondary">
              Manage Application Employees Payments
            </Typography>
          </Box>
          <Box>
            <Header
      ...
      {/* Main Card for setup Employee Payments Table */}
      <Paper
        elevation={0}
        sx={{
          borderRadius: 2,
