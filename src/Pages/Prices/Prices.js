...
import { AssignmentInd, PriceChange, Widgets, AttachMoney } from "@mui/icons-material";
...
const Prices = () => {
  ...
  return (
    ...
    >
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
          <Box>
            ...
            <Typography variant="body2" color="text.secondary">
              Manage Application Products Prices
            </Typography>
          </Box>
          <Box>
            <Header
      ...
      {/* Main Card for setup Prices Table */}
      <Paper
        elevation={0}
        sx={{
          borderRadius: 2,
